...
sprintf('%s_%s', $this->getClassnameLabel(), $action),'breadcrumb','link')
)
);
}
...
if ($method) {
@trigger_error('Option "associated_tostring" is deprecated since version 2.3. Use "associated_property" instead.',
E_USER_DEPRECATED
);
} else {
$method ='__toString';
