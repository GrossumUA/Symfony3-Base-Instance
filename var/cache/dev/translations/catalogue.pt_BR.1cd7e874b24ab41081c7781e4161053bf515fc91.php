...
',
  ...
  array (
    ...
    'flash_lock_error' => 'Outro usuário modificou o item "%name%". Por favor, %link_start%clique aqui%link_end% to para recarregar a página e aplicar as mudanças novamente.',
